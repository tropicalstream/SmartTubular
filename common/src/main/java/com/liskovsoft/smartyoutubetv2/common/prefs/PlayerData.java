...
public class PlayerData extends DataChangeBase implements PlayerConstants, ProfileChangeListener {
    ...
    private boolean mSuppressSubtitleAutoDefaultOnce;
    ...
    public void suppressSubtitleAutoDefaultOnce() {
        mSuppressSubtitleAutoDefaultOnce = true;
    }

    public boolean consumeSubtitleAutoDefaultSuppressed() {
        boolean suppressed = mSuppressSubtitleAutoDefaultOnce;
        mSuppressSubtitleAutoDefaultOnce = false;
        return suppressed;
    }
    ...
    public FormatItem getDefaultSubtitleFormat() {
        return FormatItem.fromLanguage("en");
    }
